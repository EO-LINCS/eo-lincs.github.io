...
The outcome is a working data-processing chain able to incorporate new EO data — including Sentinel-2 and Sentinel-3 — into the FLUXCOM-X framework, updatable and expandable to all sites and other products. The example case demonstrates the utility of these new data streams for predicting Net Ecosystem Exchange (NEE), with particular attention to interannual variability, drought responses, and disturbance.
...
*Time series of Sentinel-3A/3B and VIIRS vegetation indices alongside cross-validated FLUXCOM-X NEE residuals (US-SRG). From EO-LINCS D5.4.*
...
*Spatial NEE residuals from 16 sites vs the 1 km mean of each forest characteristic. From EO-LINCS D5.4.*
