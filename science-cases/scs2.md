...
- [`scientific_analysis/`](https://github.com/EO-LINCS/eo-lincs-scs2/tree/main/scientific_analysis) — `01_data_processing.ipynb` and `02_data_visualization.ipynb` reproducing the scientific analysis.
...
*Median AGB (with 25$^{th}$–75$^{th}$ percentile bands) vs stand age, by disturbance agent, for Liu and ESA-CCI biomass.*
